...
console.log(props.bottomBackgroundColor)
</script>

<template>

  <div class="node-container" v-tooltip :title="'Sparesum: ' + sum?.toString() + 'kr,-'">
    ...
    <div class="image-box">
      <img v-if="bottomBackgroundColor === '#6AB40A'" src="/src/assets/path-pig.png" alt="path-pig" class="img" width="120px">
    </div>
  </div>
